    ...
    return (
        <div
            ...
            <div
                ...
                <img className="w-96 h-96 rounded-lg" src={`images/image-product-${imageLightBox}.jpg`} alt="" />
                <button
                    ...
                    <span><img src="/images/icon-previous.svg" alt="icon previous" /></span>
                </button>
                <button
                    onClick={() => toggleImage(1)}
                    ...
                    <span><img src="/images/icon-next.svg" alt="" /></span>
                </button>
                <button onClick={closeModal}>
                    <img className="absolute -top-10 right-0 w-5 h-5" src="/images/icon-close.svg" alt="" />
                </button>
            </div>
            <div className="flex items-center justify-between w-96 mt-10">
                {sliderData.map((image, index) => (
                    <img
                        ...
                        className="rounded h-20 w-20 mr-3 cursor-pointer" src={image.url} alt="" />
                ))}
            </div>
        </div>
    )
